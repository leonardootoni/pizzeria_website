...
const URL_SIGN_IN_PAGE =
  window.location.href.substring(0, window.location.href.lastIndexOf("/")) + "/sign_in.html";

const URL_CLOSE_ORDER_PAGE =
  window.location.href.substring(0, window.location.href.lastIndexOf("/")) + "/close_order.html";
